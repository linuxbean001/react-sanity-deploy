...
function Header() {
  return (
    <>
    <nav className="Nav">
        <Link to="/"><img src="https://www.arcadeagroup.com/logo.svg" alt="Arcadea Group"/></Link>
        ...
        <Link to="#">Philosophy</Link><Link to="#">Perspectives</Link><Link to="#">People</Link><Link to="#">Blog</Link>
